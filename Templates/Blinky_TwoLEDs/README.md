...
The **Blinky Two LEDs** project can be used to verify the basic tool setup.
...
4. From **Templates, Reference Applications, and Examples** select the ""Blinky Two LEDs" template.
...
8. In GitHub Copilot, use the following prompt to get the custom VIO file generated:
   ...
   ```txt
   Can you help me creating the CMSIS-Driver VIO file for this board? The LEDs are connected to ABC and DEF on the
   microcontroller. Can you use functions from the GPIO/Peripheral Driver Library?
   ```
